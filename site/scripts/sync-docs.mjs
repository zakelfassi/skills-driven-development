...
const mappings = [
  ...
  // Global colony and MCP sync guides.
  ...
  { src: "docs/integrations/droid.md", dest: "integrations/droid.md" },
  ...
  // Examples gallery — canonical source in docs/examples.md.
  { src: "docs/examples.md", dest: "examples.md" },
